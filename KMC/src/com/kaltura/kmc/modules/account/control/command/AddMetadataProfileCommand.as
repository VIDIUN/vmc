package com.vidiun.vmc.modules.account.control.command
{
	...
	import com.vidiun.commands.metadataProfile.MetadataProfileAdd;
	...
	public class AddMetadataProfileCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void
		{
			...
			_model.selectedMetadataProfile.profile.createMode = VidiunMetadataProfileCreateMode.VMC;		
		...
		public function result(data:Object):void
		{
			...
			var listResult:VidiunMetadataProfileListResponse = responseArray[1]as VidiunMetadataProfileListResponse;
