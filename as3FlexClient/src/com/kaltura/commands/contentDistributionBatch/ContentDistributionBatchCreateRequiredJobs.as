...
// @ignore
// ===================================================================================================
package com.vidiun.commands.contentDistributionBatch
{
	import com.vidiun.delegates.contentDistributionBatch.ContentDistributionBatchCreateRequiredJobsDelegate;
	import com.vidiun.net.VidiunCall;

	/**
	* creates all required jobs according to entry distribution dirty flags
	**/
	public class ContentDistributionBatchCreateRequiredJobs extends VidiunCall
	{
