...
package com.vidiun.commands.liveStream
{
	...
	import com.vidiun.delegates.liveStream.LiveStreamAppendRecordingDelegate;
	import com.vidiun.net.VidiunCall;

	/**
	* Append recorded video to live entry
	**/
	public class LiveStreamAppendRecording extends VidiunCall
	{
		...
		**/
		public function LiveStreamAppendRecording( entryId : String,assetId : String,mediaServerIndex : String,resource : VidiunDataCenterContentResource,duration : Number,isLastChunk : Boolean=false )
		{
			service= 'livestream';
