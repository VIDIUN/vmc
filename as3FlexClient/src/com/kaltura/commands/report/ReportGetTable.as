...
package com.vidiun.commands.report
{
	...
	**/
	public class ReportGetTable extends VidiunCall
	{
		...
		**/
		public function ReportGetTable( reportType : String,reportInputFilter : VidiunReportInputFilter,pager : VidiunFilterPager,order : String = null,objectIds : String = null )
		{
			service= 'report';
			action= 'getTable';
