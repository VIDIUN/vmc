...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.eSearch
{
	import com.vidiun.vo.VidiunKeyValue;VidiunKeyValue;;
	...
	{
		public function ESearchGetAllowedSearchTypesDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
