...
package com.vidiun.vo
{
	...
	[Bindable]
	public dynamic class VidiunScheduledTaskProfile extends BaseFlexVo
	{
		/**
		**/
		...
		**/
		...
		/**
		* @see com.vidiun.types.VidiunScheduledTaskProfileStatus
		**/
		public var status : int = int.MIN_VALUE;

		/**
		* The type of engine to use to list objects using the given "objectFilter"
		* @see com.vidiun.types.VidiunObjectFilterEngineType
		**/
		...
		**/
		public var objectFilter : VidiunFilter;
