...
package com.vidiun.commands.batch
{
	...
	import com.vidiun.delegates.batch.BatchAddBulkUploadResultDelegate;
	import com.vidiun.net.VidiunCall;

	/**
	* batch addBulkUploadResultAction action adds VidiunBulkUploadResult to the DB
	**/
	public class BatchAddBulkUploadResult extends VidiunCall
	{
		public var filterFields : String;
		
		/**
		* @param bulkUploadResult VidiunBulkUploadResult
		* @param pluginDataArray Array
		**/
		public function BatchAddBulkUploadResult( bulkUploadResult : VidiunBulkUploadResult,pluginDataArray : Array=null )
		{
			service= 'batch';
