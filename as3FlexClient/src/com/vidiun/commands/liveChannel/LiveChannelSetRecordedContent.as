...
package com.vidiun.commands.liveChannel
{
	...
	import com.vidiun.delegates.liveChannel.LiveChannelSetRecordedContentDelegate;
	import com.vidiun.net.VidiunCall;

	/**
	* Set recorded video to live entry
	**/
	public class LiveChannelSetRecordedContent extends VidiunCall
	{
		...
		**/
		public function LiveChannelSetRecordedContent( entryId : String,mediaServerIndex : String,resource : VidiunDataCenterContentResource,duration : Number,recordedEntryId : String = null,flavorParamsId : int=int.MIN_VALUE )
		{
			service= 'livechannel';
