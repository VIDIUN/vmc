...
package com.vidiun.commands.report
{
	...
	**/
	public class ReportGetUrlForReportAsCsv extends VidiunCall
	{
		...
		**/
		public function ReportGetUrlForReportAsCsv( reportTitle : String,reportText : String,headers : String,reportType : String,reportInputFilter : VidiunReportInputFilter,dimension : String = null,pager : VidiunFilterPager=null,order : String = null,objectIds : String = null )
		{
			service= 'report';
